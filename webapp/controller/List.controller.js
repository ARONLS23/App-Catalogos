sap.ui.define([
    ...
    "sap/m/MessageBox"
], (Controller, JSONModel, MessageToast, Filter, FilterOperator, MessageBox) => {
    "use strict";

    return Controller.extend("tiles.controller.List", {
        onInit() {
        },
        ...
        onPressProduct: function (oEvent) {
            ...
            let indexProduct = this.getView().getModel("mProducts").getData().ProductCollection.indexOf(oItem);
        ...
        onOpenDialog: function () {
            this.fDialog ??= this.loadFragment({
                name: "tiles.view.fragments.DialogForm"
            });
                                ...
                                aFormElements.forEach(oFormElement => {
                                    ...
                                    if (aFields && aFields.length > 0) {
                                        aFields.forEach(oField => {
                                            if (oField.getValue) {
                                                let oFieldId = oField.getId().split("List--")[1];
